...
@Component({
  selector: 'app-get-customer-chat',
  templateUrl: './get-customer-chat.component.html',
  styleUrls: ['./get-customer-chat.component.scss'],
})
export class GetCustomerChatComponent implements OnInit {
  chatDetails: any[] = [];
  ...
  constructor(private _ChatHistory: ChatHistoryService , private _roomId: RoomIdService) {}
      ...
      if (chatData.conversationId == conversationId) {
        this.chatDetails.forEach((element: any) => {
          if (element.botAnswer != null ) {
            ...
            customerMessage.innerHTML = "Customer Question :--"+element.question;
